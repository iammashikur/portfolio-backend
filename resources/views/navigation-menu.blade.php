        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\BlogComment::class)
                        <x-dropdown-link href="{{ route('blog-comments.index') }}">
                        Blog Comments
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Skill::class)
                        <x-dropdown-link href="{{ route('skills.index') }}">
                        Skills
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Experience::class)
                        <x-dropdown-link href="{{ route('experiences.index') }}">
                        Experiences
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Qualification::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\ProjectCategory::class)
                        <x-dropdown-link href="{{ route('project-categories.index') }}">
                        Project Categories
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Tool::class)
                        <x-dropdown-link href="{{ route('tools.index') }}">
                        Tools
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\SocialLink::class)
                        <x-dropdown-link href="{{ route('social-links.index') }}">
                        Social Links
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\BlogCategory::class)
                <x-responsive-nav-link href="{{ route('blog-categories.index') }}">
                Blog Categories
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\BlogComment::class)
                <x-responsive-nav-link href="{{ route('blog-comments.index') }}">
                Blog Comments
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Skill::class)
                ...
                @endcan
                @can('view-any', App\Models\Experience::class)
                <x-responsive-nav-link href="{{ route('experiences.index') }}">
                Experiences
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Qualification::class)
                ...
                @endcan
                @can('view-any', App\Models\ProjectCategory::class)
                <x-responsive-nav-link href="{{ route('project-categories.index') }}">
                Project Categories
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Testimonial::class)
                ...
                @endcan
                @can('view-any', App\Models\SocialLink::class)
                <x-responsive-nav-link href="{{ route('social-links.index') }}">
                Social Links
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Message::class)
